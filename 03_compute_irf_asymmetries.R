...
if(standardize) write_rds(irf, file = paste0("output/irf_estimation_asymmetry/irf_estimates_standardized_", period, "_", shocked_variable, "_", names(sample)[-1][i], ".rds", ".rds"))
if(!standardize) write_rds(irf, file = paste0("output/irf_estimation_asymmetry/irf_estimates_", period, "_", shocked_variable, "_", names(sample)[-1][i], ".rds", ".rds"))