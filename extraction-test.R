...
if (!file.exists("data/lobster-processed-files.parquet")) {
  ...
  open_dataset("data/lobster-clean-database/") |>
    ...
    write_parquet("data/lobster-processed-files.parquet")
}

processed_files <- read_parquet("data/lobster-processed-files.parquet")

if (!file.exists("data/lobster-existing-files.parquet")) {
  tibble(
    ...
    write_parquet("data/lobster-existing-files.parquet")
}
existing_files <- read_parquet("data/lobster-existing-files.parquet")
